...
site_table <- site_level_data %>% 
  ...
  inner_join(site_coords, by = c('site', 'dod_location'))
...
qpcr_2017 <- read_csv(here("data", "qPCR_results", "SERDP_qPCR_results_2017_200314.csv")) %>% 
  clean_names()

qpcr_2018 <- read_csv(here("data", "qPCR_results", "SERDP_qPCR results_2018_191129.csv")) %>% 
  clean_names()

qpcr_2019 <- read_csv(here("data", "qPCR_results", "SERDP_qPCR results_2019_211215.csv")) %>% 
  clean_names()
